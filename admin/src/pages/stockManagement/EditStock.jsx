...
const EditStock = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`/api/stock/updateStock/${id}`, {
        method: "PUT",
      ...
      if (response.ok) {
        navigate("/view-stock"); // Redirect to the view stock page
      } else {
  ...
  return (
    <div className="flex min-h-screen relative">
      ...
      <nav className="w-64 bg-purple-400 text-white h-screen p-6 z-10">
