        ...
        <div className="flex flex-col items-center justify-center min-h-screen">
          <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Client Type */}
              <div>
                <label htmlFor="clientType" className="block text-lg font-medium text-purple-600">
                  Client Type:
                </label>
                <select
                  id="clientType"
            ...
            {/* Back Link */}
            <Link to="/client/manage" className="block text-center mt-4 text-purple-600 hover:underline">
              Back to Client List
            </Link>
          </div>
        </div>
