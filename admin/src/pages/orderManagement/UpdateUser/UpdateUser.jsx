...
function UpdateUser() {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                ...
                userData.date = formatDate(userData.date);
                setInputs(userData); // Populate the form fields with the user data
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/data'); // Redirect after successful update
        } catch (error) {
            ...
            <div className="update-user-container">
                ...
                <form onSubmit={handleSubmit} className="update-user-form">
                    ...
                    <input
                        ...
                        type="text"
                        name="date"
                        value={inputs.date} // Show current date in mm/dd/yyyy format
